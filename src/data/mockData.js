...
export const carouselSlides = [
  {
    id: 1,
    src: carousel1,
    alt: 'Rise Above Foundation Cebu community program',
    badge: 'Our Mission',
    title: 'Empowering Communities Through Action',
    description: 'Since 2000, we\'ve been improving lives in Cebu through education, healthcare, and livelihood programs.',
  },
  {
    id: 2,
    src: carousel2,
    alt: 'Children and families supported by Rise Above',
    badge: 'Family Support',
    title: 'Building Stronger Families',
    description: 'Supporting families to rise above poverty through comprehensive care and educational opportunities.',
  },
  {
    id: 3,
    src: carousel3,
    alt: 'Volunteer activities in Cebu',
    badge: 'Volunteer Program',
    title: 'Join Our Global Community',
    description: 'Connecting volunteers from around the world to create lasting change in Cebu communities.',
  },
  {
    id: 4,
    src: carousel4,
    alt: 'Education and youth programs',
    badge: 'Education',
    title: 'Investing in the Next Generation',
    description: 'Providing educational sponsorships and opportunities for children to achieve their dreams.',
  },
  {
    id: 5,
    src: carousel5,
    alt: 'Health and hygiene outreach',
    badge: 'Health & Hygiene',
    title: 'Promoting Healthy Communities',
    description: 'Delivering essential health services and hygiene education to underprivileged areas.',
  },
  {
    id: 6,
    src: carousel6,
    alt: 'Community center activities',
    badge: 'Community Center',
    title: 'A Safe Space for Growth',
    description: 'Our community center provides children with a nurturing environment for learning and play.',
  },
  {
    id: 7,
    src: carousel7,
    alt: 'Livelihood and craft programs',
    badge: 'Livelihood',
    title: 'Creating Sustainable Income',
    description: 'Empowering women through craft training and Rise Up Craft Creations micro-enterprise.',
  },
  {
    id: 8,
    src: carousel8,
    alt: 'Dental and medical missions',
    badge: 'Medical Missions',
    title: 'Healthcare for Those in Need',
    description: 'Free dental and medical services provided by international volunteers and local professionals.',
  },
  {
    id: 9,
    src: carousel9,
    alt: 'Food sharing and child care',
    badge: 'Nutrition Program',
    title: 'Nourishing Young Lives',
    description: 'Ensuring children receive nutritious meals and proper care for healthy development.',
  },
  {
    id: 10,
    src: carousel10,
    alt: 'Partnerships and community impact',
    badge: 'Together We Rise',
    title: 'Making a Lasting Impact',
    description: 'Building partnerships that transform communities and create hope for a better future.',
  },
]
